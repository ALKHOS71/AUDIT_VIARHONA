var size = 0;
var placement = 'point';
function categories_BDVIARHONASIGNALISATIONEQUIPEMENT_7(feature, value, size, resolution, labelText,
...
var style_BDVIARHONASIGNALISATIONEQUIPEMENT_7 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var bufferWidth = 3.300000000000002;
    var textAlign = "left";
    var offsetX = 8;
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("ID_photo") !== null) {
        labelText = String(feature.get("ID_photo"));
    }
    
var style = categories_BDVIARHONASIGNALISATIONEQUIPEMENT_7(feature, value, size, resolution, labelText,
